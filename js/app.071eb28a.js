...
/******/ 		return __webpack_require__.p + "js/" + ({}[chunkId]||chunkId) + "." + {"chunk-6728a27e":"1d893e68","chunk-42c51506":"899ed62a"}[chunkId] + ".js"
/******/ 	}
/******/
...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    console.log({"time":1600732853622,"branch":"master","commit":"fae153ae46a8b9dcb27254a77c2856c6696bf045","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/729161532"}); // eslint-disable-next-line no-unused-expressions
    ...
    this.$store.dispatch('init').then(function () {
      ...
      if (!localStorage.getItem('disableTelemetry')) {
        ...
        _this.$http.post(config.telemetryServer + '/session', {
          application: 'Arena',
          application_version: {"time":1600732853622,"branch":"master","commit":"fae153ae46a8b9dcb27254a77c2856c6696bf045","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/729161532"}.branch,
          data: JSON.stringify({
            commit: {"time":1600732853622,"branch":"master","commit":"fae153ae46a8b9dcb27254a77c2856c6696bf045","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/729161532"}.commit,
            startDemo: !!demo,
...
/******/ });
//# sourceMappingURL=app.071eb28a.js.map