...
/******/ 		return __webpack_require__.p + "js/" + ({}[chunkId]||chunkId) + "." + {"chunk-740aa32e":"eed88a09","chunk-42c51506":"4711e16e"}[chunkId] + ".js"
/******/ 	}
/******/
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2b72355c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/App.vue?vue&type=template&id=395f4d36&
...
/* harmony default export */ var FunnelMeasurevue_type_script_lang_js_ = ({
  ...
  computed: Object(objectSpread2["a" /* default */])({
    ...
    axisUnit: function axisUnit() {
      ...
      return 1 / ((_this$variables = this.variables).slice.apply(_this$variables, Object(toConsumableArray["a" /* default */])(this.pageRange)).reduce(function (acu, v) {
        return acu + _this2.subsets[v].length + 1.5;
      }, 0) + 2);
    },
    variableOffset: function variableOffset() {
      ...
      var lengths = this.variables.map(function (v) {
        return _this3.subsets[v].length + 1.5;
      }).map(function (v, i) {
        return i >= _this3.pageRange[0] && i < _this3.pageRange[1] ? v : 0;
      });
    ...
    transformed: function transformed() {
      ...
      return this.data.slice(1).map(function (x) {
        ...
        var variables = (_Object$entries = Object.entries(x.plotData.lossValues)).slice.apply(_Object$entries, Object(toConsumableArray["a" /* default */])(_this5.pageRange));

        var points = variables.map(function (entry) {
          return Object.entries(entry[1]).map(function (e) {
            var offset = _this5.variableOffset[entry[0]] + (_this5.subsets[entry[0]].indexOf(e[0]) + 1.5) * _this5.axisUnit;
    ...
    layout: function layout() {
      ...
      return {
        ...
        dragmode: 'pan',
        hovermode: 'closest',
        shapes: (_Object$values = Object.values(this.variableOffset)).slice.apply(_Object$values, Object(toConsumableArray["a" /* default */])(this.pageRange)).map(function (off) {
          return {
            type: 'line',
            x0: 0,
            x1: 1,
        ...
        annotations: (_Object$entries2 = Object.entries(this.variableOffset)).slice.apply(_Object$entries2, Object(toConsumableArray["a" /* default */])(this.pageRange)).map(function (x) {
          return {
            x: 0.05,
            y: x[1] + _this8.axisUnit * 0.2,
            bgcolor: 'white',
...
var FunnelMeasure_component = Object(componentNormalizer["a" /* default */])(
  ...
  FunnelMeasurevue_type_template_id_382d960e_render,
  FunnelMeasurevue_type_template_id_382d960e_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    console.log({"time":1595377393457,"branch":"master","commit":"39032c384679e166fee729fc7419793e5bab9540","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/710583314"}); // eslint-disable-next-line no-unused-expressions
    ...
    this.$store.dispatch('init').then(function () {
      ...
      if (!localStorage.getItem('disableTelemetry')) {
        ...
        _this.$http.post(config.telemetryServer + '/session', {
          application: 'Arena',
          application_version: {"time":1595377393457,"branch":"master","commit":"39032c384679e166fee729fc7419793e5bab9540","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/710583314"}.branch,
          data: JSON.stringify({
            commit: {"time":1595377393457,"branch":"master","commit":"39032c384679e166fee729fc7419793e5bab9540","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/710583314"}.commit,
            startDemo: !!demo,
...
/******/ });
//# sourceMappingURL=app.2e1e6746.js.map