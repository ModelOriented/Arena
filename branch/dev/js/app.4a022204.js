...
/******/ 		return __webpack_require__.p + "js/" + ({}[chunkId]||chunkId) + "." + {"chunk-740aa32e":"60c1b235","chunk-42c51506":"9935191f"}[chunkId] + ".js"
/******/ 	}
/******/
...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    console.log({"time":1595346483454,"branch":"dev","commit":"d897173193738f503649f047dc68012cadea7eaa","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/710440267"}); // eslint-disable-next-line no-unused-expressions
    ...
    this.$store.dispatch('init').then(function () {
      ...
      if (!localStorage.getItem('disableTelemetry')) {
        ...
        _this.$http.post(config.telemetryServer + '/session', {
          application: 'Arena',
          application_version: {"time":1595346483454,"branch":"dev","commit":"d897173193738f503649f047dc68012cadea7eaa","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/710440267"}.branch,
          data: JSON.stringify({
            commit: {"time":1595346483454,"branch":"dev","commit":"d897173193738f503649f047dc68012cadea7eaa","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/710440267"}.commit,
            startDemo: !!demo,
...
/******/ });
//# sourceMappingURL=app.4a022204.js.map