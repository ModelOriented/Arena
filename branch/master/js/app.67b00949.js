...
/******/ 		return __webpack_require__.p + "js/" + ({}[chunkId]||chunkId) + "." + {"chunk-6728a27e":"43e5b040","chunk-42c51506":"a2babe5a"}[chunkId] + ".js"
/******/ 	}
/******/
...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    console.log({"time":1595377928790,"branch":"master","commit":"09370809c4b261ba468258107fae2cf6b6e907d4","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/710584649"}); // eslint-disable-next-line no-unused-expressions
    ...
    this.$store.dispatch('init').then(function () {
      ...
      if (!localStorage.getItem('disableTelemetry')) {
        ...
        _this.$http.post(config.telemetryServer + '/session', {
          application: 'Arena',
          application_version: {"time":1595377928790,"branch":"master","commit":"09370809c4b261ba468258107fae2cf6b6e907d4","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/710584649"}.branch,
          data: JSON.stringify({
            commit: {"time":1595377928790,"branch":"master","commit":"09370809c4b261ba468258107fae2cf6b6e907d4","buildurl":"https://travis-ci.org/ModelOriented/Arena/builds/710584649"}.commit,
            startDemo: !!demo,
...
/******/ });
//# sourceMappingURL=app.67b00949.js.map